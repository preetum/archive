...
namespace Utilities
{
    public static class GraphicsUtils
    {
        ...
        public static void DrawBallTex(Texture2D tex, Vector2 cent, float rad, float rot, byte a)
        {
            var c = Color.White;
            c.A = a;
            _spriteBatch.Draw(tex, cent, null, c, rot, new Vector2(tex.Width / 2, tex.Height / 2), 2 * rad / tex.Width, SpriteEffects.None, 0.5f);
        }
        ...
        /// <param name="depth">0.0=top, 1.0=bottom</param>
